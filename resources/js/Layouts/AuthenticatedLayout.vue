...
<template>
    <div class="flex flex-col h-screen bg-gray-100 overflow-hidden relative">
      ...
      <header class="absolute top-0 right-0 h-16 flex items-center justify-end px-8 z-[60] pointer-events-none">
            <div class="flex items-center gap-3 pointer-events-auto">
                <Link v-if="canSeeNotifications"
                    :href="route('transactions.approval')" 
                    class="w-10 h-10 flex items-center justify-center text-gray-500 hover:text-black transition-all relative bg-white rounded-full shadow-md border border-gray-100"
                >
                ...
                <Link 
                    ...
                    method="post" 
                    as="button" 
                    class="w-10 h-10 flex items-center justify-center text-gray-500 hover:text-red-600 transition-all bg-white rounded-full shadow-md border border-gray-100"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
