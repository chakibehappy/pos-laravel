...
// Fungsi toggle manual (tombol hamburger)
const toggleSidebar = () => {
...
<template>
    <div class="flex h-screen bg-gray-100 overflow-hidden">
        <Sidebar :isMinimized="isMinimized" @expand="expandSidebar" />

        <div class="flex-1 flex flex-col overflow-hidden transition-all duration-300">
            <header class="h-16 bg-white border-b border-black flex items-center justify-between px-8 shrink-0">
                <div class="flex items-center gap-4">
                    <button 
                        @click="toggleSidebar" 
                        class="p-2 hover:bg-gray-100 rounded-lg transition-colors text-black"
                    >
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-xs font-mono bg-gray-100 p-1 border border-black/5 rounded">
